...
# 1. work dir
```{r}
wd <- fs::path('/Users/xuewei/ZxProjects/CRC/2023_GSE231559/01_preprocessing/40_GEO_validate/median/02_GSE17536/')
...
```{r}
expr_data <- read_rds(fs::path(wd_i, 'GSE17536_gene_expr.rds'))
clin_data <- read_rds(fs::path(wd_i, 'GSE17536_clin_info.rds'))
expr_surv <- read_rds(fs::path(wd_i, 'GSE17536_expr_surv.rds'))

# expr_data2 <- expr_data %>% 
#   column_to_rownames(var="Gene Symbol")
# expr_data3 <- scale(expr_data2) %>% 
#   as.data.frame()
# expr_data4 <- expr_data3 %>% 
#   rownames_to_column(var="Gene")
# 
# # expr_data5 <- as.data.frame(data.table::transpose(expr_data4, keep.names = "Gene", make.names = 1))
# 
# write.table(expr_data4, file="expr_data.txt", sep = "\t", quote=F, row.names = F)
...
pdf("20231113_40_GEO_GSE17536_v3_all.pdf",height=6,width=6)
p1 <- ggsurvplot(fit,
