...
# 1. work dir
```{r}
wd <- fs::path('/Users/xuewei/ZxProjects/CRC/2023_GSE231559/01_preprocessing/40_GEO_validate/median/04_GSE29621/')
...
```{r}
# expr_data <- read_rds(fs::path(wd_i, 'GSE29621_gene_expr.rds'))
# clin_data <- read_rds(fs::path(wd_i, 'GSE29621_clin_info.rds'))
expr_surv <- read_rds(fs::path(wd_i, 'GSE29621_expr_surv.rds'))
...
pdf("20231113_40_GEO_GSE29621_v3_all.pdf",height=6,width=6)
p1 <- ggsurvplot(fit,
